...
//Taken from Aion codebase.
//Added encodeArguments() to Constructor class
public final class Abi {
    ...
    public static abstract class Entry {
        ...
        public Entry(
            Boolean anonymous, Boolean constant, Boolean payable, String name, List<Param> inputs, List<Param> outputs,
            Type type) {
    ...
    public static class Constructor extends Entry {
        ...
        //Added by aion-graphql to encode constructor arguments.s
